...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://guarded-springs-12986.herokuapp.com',
...
var removeSurvey = function removeSurvey(surveyId) {
  return $.ajax({
    method: 'DELETE',
...
var updateSurvey = function updateSurvey(data, surveyId) {
  return $.ajax({
    method: 'PATCH',
    url: config.apiUrl + '/surveys/' + surveyId,
    data: data,
...
var store = __webpack_require__(2);
var showAllSurveys = __webpack_require__(18);
var showUserSurveys = __webpack_require__(35);
...
var createSurveyError = function createSurveyError(_createSurveyError) {
  $('#create-survey-form')[0].reset();
...
var getSurveysSuccess = function getSurveysSuccess(data) {
  ...
  if (data.surveys.length > 0) {
    var showSurveysHtml = showAllSurveys({
...
var getSurveysError = function getSurveysError(data) {};

var getUserSurveysSuccess = function getUserSurveysSuccess(data) {
  store.surveys = data.surveys;
  var userSurveys = [];
  for (var i = 0; data.surveys.length > i; i++) {
  ...
  if (userSurveys.length > 0) {
    var showUserSurveysHtml = showUserSurveys({
      surveys: userSurveys
    });
    $('#create-survey').delay(100).fadeOut(100);
    $('#dashboard').delay(100).fadeOut(100);
...
var getUserSurveysError = function getUserSurveysError(data) {};

var updateSurveySuccess = function updateSurveySuccess(updateSurveyResponse) {
  $('#successModal').modal('show');
  $('#success-message').html('Your survey has been updated!');
};

var updateSurveyError = function updateSurveyError(_updateSurveyError) {};

var removeSurveySuccess = function removeSurveySuccess(data) {
  store.surveys = data.surveys;
  var userSurveys = [];
  for (var i = 0; data.surveys.length > i; i++) {
    if (data.surveys[i].owner === store.user._id) {
...
var removeSurveyError = function removeSurveyError(_removeSurveyError) {};

module.exports = {
  createSurveySuccess: createSurveySuccess,
  createSurveyError: createSurveyError,
  getSurveysSuccess: getSurveysSuccess,
  getSurveysError: getSurveysError,
  removeSurveySuccess: removeSurveySuccess,
  removeSurveyError: removeSurveyError,
  updateSurveySuccess: updateSurveySuccess,
  updateSurveyError: updateSurveyError,
  getUserSurveysError: getUserSurveysError,
  getUserSurveysSuccess: getUserSurveysSuccess
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var responseEvents = __webpack_require__(36);
...
var authApi = __webpack_require__(15);
...
var getFormFields = __webpack_require__(4);
var surveysApi = __webpack_require__(6);
var surveysUi = __webpack_require__(7);
...
var onCreateSurveyTab = function onCreateSurveyTab(event) {
  event.preventDefault();
  $('#dashboard').delay(100).fadeOut(100);
...
var refreshSurveys = function refreshSurveys(event) {
  $('.show-content').html('');
  surveysApi.getSurveys().then(surveysUi.getUserSurveysSuccess).catch();
};

var refreshSurveysOnDelete = function refreshSurveysOnDelete(event) {
  $('.show-content').html('');
  surveysApi.getSurveys().then(surveysUi.removeSurveySuccess).catch();
};

var onCreateSurvey = function onCreateSurvey(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  surveysApi.createSurvey(data).then(surveysUi.createSurveySuccess).catch(surveysUi.createSurveyError);
};

var onGetSurveys = function onGetSurveys(event) {
  event.preventDefault();
  surveysApi.getSurveys().then(surveysUi.getSurveysSuccess).catch(surveysUi.getSurveysError);
};

var onGetUserSurveys = function onGetUserSurveys(event) {
  event.preventDefault();
  surveysApi.getSurveys().then(surveysUi.getUserSurveysSuccess).catch(surveysUi.getUserSurveysError);
};

var onRemoveSurvey = function onRemoveSurvey(event) {
  event.preventDefault();
  var surveyId = $(event.target).attr('data-id');
  surveysApi.removeSurvey(surveyId).then(refreshSurveysOnDelete).catch(surveysUi.removeSurveyError);
};
...
var onUpdateSurvey = function onUpdateSurvey(event) {
  ...
  var data = getFormFields(event.target);
  var surveyId = $(event.target).attr('data-id');
  surveysApi.updateSurvey(data, surveyId).then(surveysUi.updateSurveySuccess).catch(surveysUi.updateSurveyError).then(refreshSurveys);
};

module.exports = {
  onDashNav: onDashNav,
  onCreateSurveyTab: onCreateSurveyTab,
  onCreateSurvey: onCreateSurvey,
  onGetSurveys: onGetSurveys,
  onRemoveSurvey: onRemoveSurvey,
  onUpdateSurvey: onUpdateSurvey,
  onGetUserSurveys: onGetUserSurveys,
  refreshSurveysOnDelete: refreshSurveysOnDelete
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n  <div id=\"view-all-surveys-handlebars\" class=\"card\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n    <div class=\"card-body col-sm-2 col-med-2\" style=\"background-color: white; width: 31.5%; min-height: 300px; margin: 10px; padding-top: 20px;\">\n      <div class=\"show-options col-xs-12 response-message\">\n        <h3><b>Question:</b> "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.question : stack1), depth0))
    + "</h3>\n        <form class=\"survey-response-form\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\">\n          <fieldset>\n            <h3><input type=\"radio\" name=\"response\" value=\"True\"><b>&nbsp;True</b></h3>\n            <h3><input type=\"radio\" name=\"response\" value=\"False\"><b>&nbsp;False</b></h3>\n          </fieldset>\n          <button style=\"margin: 15px 5px;\" type=\"submit\" class=\"btn btn-success submit-response\" data-class=\"submit-response\" data-id='"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "'>SUBMIT RESPONSE</button>\n          <button style=\"margin: 15px 5px;\" class=\"btn btn-info view-responses\" data-class=\"view-responses\" data-id='"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n  <div class=\"handlebars\" id=\"survey-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\">\n    <div class=\"card-body col-sm-2 col-med-2\" style=\"background-color: white; width: 31.5%; min-height: 300px; margin: 10px; padding-top: 20px;\">\n      <h3 data-id="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "><strong>Question:</strong> "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.question : stack1), depth0))
    + "</h3>\n      <form class='update-survey' data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\">\n        <input type=\"text\" name=\"survey[question]\" tabindex=\"4\" class=\"form-control\" placeholder=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.question : stack1), depth0))
    + "\" required>\n        <button style=\"margin: 15px 5px;\" type=\"submit\" class=\"btn btn-info btn-style\">UPDATE SURVEY</button>\n        <button style=\"margin: 15px 5px;\" class=\"btn btn-danger btn-style delete-survey\" data-id='"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
...
var onCreateResponse = function onCreateResponse(event) {
  ...
  if (value != null) {
    api.createResponse(value, surveyId).then(ui.createResponseSuccess).catch(ui.createResponseFailure);
  } else {
...
var onGetResponses = function onGetResponses(event) {
  event.preventDefault();
  var surveyId = $(event.target).attr('data-id');
  api.getResponses(surveyId).then(ui.getResponsesSuccess).catch(ui.getResponsesFailure);
};

module.exports = {
  onGetResponses: onGetResponses,
...
var createResponse = function createResponse(value, surveyId) {
  return $.ajax({
...
var getResponses = function getResponses(surveyId) {
  return $.ajax({
...
var refreshSurveys = function refreshSurveys(event) {
  $('.show-content').html('');
  surveysApi.getSurveys().then(surveysUi.getSurveysSuccess).catch();
};
...
var createResponseFailure = function createResponseFailure(data) {
  $('#messageModal').modal('show');
...
var getResponsesError = function getResponsesError(data) {};
...
module.exports = {
  ...
  getResponsesError: getResponsesError
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
